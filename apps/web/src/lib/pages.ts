      ...
      },
      {
        ...
        body: pick(locale, {
          en: [
            ...
            '- A venue pays Vardenia a small fee for each guest who books through us and comes. You pay the venue its usual price and nothing more, and a business cannot pay to be ranked above another in a way that is hidden from you.',
          ],
          ar: [
            ...
            '- يدفع المكان لفاردينيا رسماً صغيراً عن كل ضيف يحجز عبرنا ويحضر. أنت تدفع للمكان سعره المعتاد لا أكثر، ولا يستطيع مكان أن يدفع ليظهر فوق غيره بطريقة مخفية عنك.',
          ],
          fr: [
            ...
            "- Un établissement verse à Vardenia de petits frais pour chaque client qui réserve par notre intermédiaire et se présente. Vous payez à l'établissement son prix habituel, rien de plus, et un établissement ne peut pas payer pour être classé devant un autre d'une manière qui vous serait cachée.",
          ],
          es: [
            ...
            '- Cada local paga a Vardenia una pequeña tarifa por cada cliente que reserva a través de nosotros y acude. Tú pagas al local su precio habitual y nada más, y un negocio no puede pagar para aparecer por encima de otro de una forma que se te oculte.',
          ],
          pt: [
            ...
            '- Cada estabelecimento paga à Vardenia uma pequena taxa por cada cliente que reserva através de nós e comparece. Você paga ao estabelecimento o preço de sempre e nada mais, e um negócio não pode pagar para aparecer acima de outro de um jeito que fique escondido de você.',
          ],
          ru: [
            ...
            '- Заведение платит Vardenia небольшой сбор за каждого гостя, который забронировал через нас и пришёл. Вы платите заведению его обычную цену и ничего сверх неё, а заведение не может заплатить, чтобы скрыто от вас оказаться выше другого.',
          ],
          zh: [
            ...
            '- 每位通过我们预订并实际到店的客人，商户会向 Vardenia 支付一笔小额费用。您向商户支付的仍是其正常价格，不多付一分，商户也无法以对您隐瞒的方式付费排到别人前面。',
          ],
          hi: [
            ...
            '- हमारे ज़रिए बुक करके आने वाले हर मेहमान के लिए व्यवसाय Vardenia को एक छोटा शुल्क देता है। आप व्यवसाय को उसकी सामान्य क़ीमत ही देते हैं, उससे ज़्यादा कुछ नहीं, और कोई व्यवसाय आपसे छिपाकर पैसे देकर किसी दूसरे से ऊपर नहीं आ सकता।',
          ],
          bn: [
            ...
            '- আমাদের মাধ্যমে বুক করে যে অতিথি আসেন, তাঁদের প্রত্যেকের জন্য ব্যবসাটি Vardenia-কে একটি ছোট ফি দেয়। আপনি ব্যবসাটিকে তার স্বাভাবিক দামই দেন, এর বেশি কিছু নয়, আর কোনো ব্যবসা আপনার অগোচরে টাকা দিয়ে অন্যদের ওপরে উঠতে পারে না।',
          ],
          ur: [
            ...
            '- ہمارے ذریعے بکنگ کر کے آنے والے ہر مہمان کے لیے کاروبار Vardenia کو ایک چھوٹی فیس دیتا ہے۔ آپ کاروبار کو اس کی معمول کی قیمت ہی دیتے ہیں، اس سے زیادہ کچھ نہیں، اور کوئی کاروبار آپ سے چھپا کر پیسے دے کر دوسرے سے اوپر نہیں آ سکتا۔',
          ],
        }),
      },
      {
      ...
      },
      {
        ...
        body: pick(locale, {
          en: [
            ...
            'Bookings carry a small fixed fee for each guest who books through Vardenia and comes, set out in the agreement a venue signs. Nothing is charged for a no-show or a cancellation, and the guest pays the venue its usual price.',
          ...
          ar: [
            ...
            'على الحجوزات رسم ثابت صغير عن كل ضيف يحجز عبر فاردينيا ويحضر، محدّد في الاتفاق الذي يوقّعه المكان. لا يُحتسب شيء إذا لم يحضر الضيف أو ألغى، والضيف يدفع للمكان سعره المعتاد.',
          ...
          fr: [
            ...
            "Les réservations donnent lieu à de petits frais fixes pour chaque client qui réserve par Vardenia et se présente, fixés dans l'accord signé par l'établissement. Rien n'est facturé pour un client absent ou une annulation, et le client paie à l'établissement son prix habituel.",
          ...
          es: [
            ...
            'Las reservas llevan una pequeña tarifa fija por cada cliente que reserva a través de Vardenia y acude, fijada en el acuerdo que firma el local. No se cobra nada por una ausencia ni por una cancelación, y el cliente paga al local su precio habitual.',
          ...
          pt: [
            ...
            'As reservas têm uma pequena taxa fixa por cada cliente que reserva através da Vardenia e comparece, definida no acordo que o estabelecimento assina. Nada é cobrado por uma ausência ou um cancelamento, e o cliente paga ao estabelecimento o preço de sempre.',
          ...
          ru: [
            ...
            'За бронирования взимается небольшой фиксированный сбор за каждого гостя, который забронировал через Vardenia и пришёл, как указано в договоре, который подписывает заведение. За неявку или отмену ничего не взимается, а гость платит заведению его обычную цену.',
          ...
          zh: [
            ...
            '每位通过 Vardenia 预订并实际到店的客人，预订会产生一笔小额固定费用，具体写在商户签署的协议中。客人未到或取消不收取任何费用，客人向商户支付的仍是其正常价格。',
          ...
          hi: [
            ...
            'Vardenia के ज़रिए बुक करके आने वाले हर मेहमान पर एक छोटा तय शुल्क लगता है, जो व्यवसाय के हस्ताक्षर किए समझौते में लिखा होता है। मेहमान के न आने या रद्द करने पर कुछ नहीं लिया जाता, और मेहमान व्यवसाय को उसकी सामान्य क़ीमत ही देता है।',
          ...
          bn: [
            ...
            'Vardenia-র মাধ্যমে বুক করে যে অতিথি আসেন, তাঁদের প্রত্যেকের জন্য একটি ছোট নির্দিষ্ট ফি আছে, যা ব্যবসার স্বাক্ষর করা চুক্তিতে লেখা থাকে। অতিথি না এলে বা বাতিল করলে কিছু নেওয়া হয় না, আর অতিথি ব্যবসাটিকে তার স্বাভাবিক দামই দেন।',
          ...
          ur: [
            ...
            'Vardenia کے ذریعے بکنگ کر کے آنے والے ہر مہمان پر ایک چھوٹی مقررہ فیس ہوتی ہے، جو اس معاہدے میں لکھی ہوتی ہے جس پر کاروبار دستخط کرتا ہے۔ مہمان کے نہ آنے یا منسوخی پر کچھ نہیں لیا جاتا، اور مہمان کاروبار کو اس کی معمول کی قیمت ہی دیتا ہے۔',
