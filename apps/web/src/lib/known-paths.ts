...
export const UNMATCHED_PREFIXES = [
  ...
  'auth',
  'booking',
  // The review submit endpoint, a POST action rather than a page. Excluded from
  // the matcher alongside auth and booking so it is never rewritten into a locale.
  'reviews',
