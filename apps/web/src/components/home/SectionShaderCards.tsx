...
function shaderFor(index: number) {
  ...
  const variants = [
    { proportion: 0.32, softness: 0.9, distortion: 0.14, swirl: 0.6, swirlIterations: 8, shape: 'checks' as const, shapeScale: 0.09 },
    { proportion: 0.4, softness: 1.15, distortion: 0.2, swirl: 0.85, swirlIterations: 11, shape: 'stripes' as const, shapeScale: 0.12 },
    { proportion: 0.36, softness: 0.95, distortion: 0.17, swirl: 0.7, swirlIterations: 10, shape: 'checks' as const, shapeScale: 0.1 },
    { proportion: 0.44, softness: 1.05, distortion: 0.21, swirl: 0.78, swirlIterations: 13, shape: 'edge' as const, shapeScale: 0.11 },
    { proportion: 0.34, softness: 0.88, distortion: 0.15, swirl: 0.66, swirlIterations: 9, shape: 'checks' as const, shapeScale: 0.08 },
    { proportion: 0.42, softness: 1.1, distortion: 0.19, swirl: 0.82, swirlIterations: 12, shape: 'stripes' as const, shapeScale: 0.13 },
    { proportion: 0.38, softness: 1.0, distortion: 0.16, swirl: 0.72, swirlIterations: 10, shape: 'edge' as const, shapeScale: 0.1 },
  ]
